...
import DuyuruScreen from './DuyuruScreen'
            ...
            <SafeAreaView style={{ flex:1}}>
                ...
                <NavigationContainer>
                    ...
                    >
                        ...
                        options={{
                            tabBarLabel: 'Home',
                            tabBarIcon: ({color , size}) => (<Icon name='home' color={color}  size ={size} ></Icon>)
                        }}
                        >
                        </Tab.Screen>
                        ...
                        options={{
                            tabBarLabel: 'Create',
                            tabBarIcon: ({color , size}) => (<Icon name='pencil' color={color}  size ={size} ></Icon>)
                        }}
                        >
